...
const { getUserInfo,snsSignUp, isExistSnsId } = require('../../db/user');

dotenv.config();

const GOOGLE_AUTH_URL = "https://accounts.google.com/o/oauth2/v2/auth"
const GOOGLE_AUTH_TOKEN_URL= "https://oauth2.googleapis.com/token"
const GOOGLE_AUTH_REDIRECT_URL = "http://localhost:3001/user/auth/google/callback"

router.post("/auth/client-refresh", (req, res, next) =>{
...
router.get("/auth/google/callback", async(req, res, next) => {
  ...
  try{
    ...
    const {sub, email, name,picture} = me;
